...
Quick-reference tables for looking things up. **The explanations are in the lessons**; this page only collects the forms. Each table names the unit that teaches it. New tables are added as the course reaches each stage. For word order, see the [Sentence Map](Sentence_Map.md).

**Contents:**
- [A1: Present tense](#a1-present-tense)
- [A1: Modal verbs](#a1-modal-verbs)
- [A1: Articles, nominative and accusative](#a1-articles-nominative-and-accusative)
- [A1: Personal pronouns](#a1-personal-pronouns)
- [A1: Possessive articles](#a1-possessive-articles)
- [A1: Question words](#a1-question-words)
...
Taught in [A1-U01](../A1/A1-U01_Ich_und_du.md) §A.

| | regular: *wohnen* | stem ends in -t/-d: *arbeiten* | *sein* | *haben* | e → i: *sprechen* | a → ä: *fahren* |
|---|---|---|---|---|---|---|
| ich | wohn**e** | arbeit**e** | **bin** | hab**e** | sprech**e** | fahr**e** |
| du | wohn**st** | arbeit**est** | **bist** | **hast** | spr**i**ch**st** | f**ä**hr**st** |
| er/sie/es | wohn**t** | arbeit**et** | **ist** | **hat** | spr**i**ch**t** | f**ä**hr**t** |
| wir | wohn**en** | arbeit**en** | **sind** | hab**en** | sprech**en** | fahr**en** |
| ihr | wohn**t** | arbeit**et** | **seid** | hab**t** | sprech**t** | fahr**t** |
| sie/Sie | wohn**en** | arbeit**en** | **sind** | hab**en** | sprech**en** | fahr**en** |

**Notes:**
- **Stem-changing verbs** change only for *du* and *er/sie/es*.
  - e → i: *sprechen, essen (isst), geben, nehmen (nimmt), helfen, treffen*
  - e → ie: *lesen, sehen*
  - a → ä: *fahren, schlafen, tragen, waschen*
- **Stems ending in -s/-ß/-z** add only *-t* for *du*: *du heißt, du tanzt*.
...
Taught in [A1-U04](../A1/A1-U04_Koennen_muessen_duerfen.md).
...
- *ich* and *er/sie/es* have the **same form and no ending**: *ich kann, er kann*.
- The second verb goes to the end as an **infinitive**: *Ich **kann** heute nicht **kommen**.*

## A1: Articles, nominative and accusative

Taught in [A1-U02](../A1/A1-U02_Essen_und_Einkaufen.md) §A–§C.

| | masculine | neuter | feminine | plural |
|---|---|---|---|---|
| **Nominative**: definite | der | das | die | die |
| **Nominative**: indefinite | ein | ein | eine | – |
| **Nominative**: negative | kein | kein | keine | keine |
| **Accusative**: definite | **den** | das | die | die |
| **Accusative**: indefinite | **einen** | ein | eine | – |
| **Accusative**: negative | **keinen** | kein | keine | keine |

- **Only the masculine changes** in the accusative: *der → den, ein → einen, kein → keinen*.
- **Accusative = the direct object** (what you have, need, buy, see …): *Ich brauche **einen** Stift.*
- ***es gibt*** always takes the accusative: *Es gibt **einen** Supermarkt hier.*

**Gender clues** (endings that almost always tell you the gender):
...
|---|---|---|---|
| **wer?** | who? (⚠️ not "where") | **wann?** | when? |
| **was?** | what? | **wie?** | how? |
| **wo?** | where? (⚠️ not "who") | **wie viel? / wie viele?** | how much? / how many? |
| **woher?** | where from? | **warum?** | why? |
| **wohin?** | where to? | **welcher / welche / welches?** | which? |

## A1: Imperative

Taught in A1-U04 §C.

| | *kommen* | *warten* | *sprechen* (e → i) | *sein* | separable *anrufen* |
|---|---|---|---|---|---|
| du | Komm! | Warte! | **Sprich!** | Sei! | Ruf … an! |
| ihr | Kommt! | Wartet! | Sprecht! | Seid! | Ruft … an! |
| Sie | Kommen Sie! | Warten Sie! | Sprechen Sie! | Seien Sie! | Rufen Sie … an! |

- The ***du***-form: take the *du*-form without *-st* and without *du* (*du kommst → Komm!*).
- **a → ä verbs don't change:** *du fährst → **Fahr**!*
- Soften commands with ***bitte*** and ***mal***: *Komm **mal** her! Warte **bitte** kurz!*
...
|---|---|---|
| **um** | clock times | um 8 Uhr, um halb neun |
| **am** | days, parts of the day, dates | am Montag, am Wochenende, am Abend, am 3. Mai |
| **im** | months, seasons | im Juli, im Sommer |
| **von … bis** | from … to | von 9 bis 17 Uhr |
| **ab** | from … on | ab Montag, ab 8 Uhr |

**Exceptions:**
- *in der Nacht*
- ***Jahre take no preposition***: *2025 bin ich …* or *im Jahr 2025*.
- Adverbs without a preposition: *morgens, abends, montags* ("in the mornings", "on Mondays").
