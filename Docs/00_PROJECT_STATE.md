...
>
> **Last updated:** 2026-09-13. Session 7: M9 abgeschlossen (B2 vollstaendig); **M7 laeuft** — B1-U07 und B1-U08 gebaut (V-032, V-033). **Update at every milestone or batch boundary.**
...
Status:             IN PROGRESS
Current batch:      M7 WP1 (B1.2): B1-U07 und B1-U08 gebaut (V-032, V-033). Sequenz auf Nutzerwunsch: B2 vor M7/M8.
Next task:          **M7 WP1**: **B1-U09 Bildung & Zukunft** (Futur I inkl. Vermutung, Wortbildung, Nominalstil rezeptiv; strukturierte Präsentation), dann **B1-R2** (Appendix G, drei Sitzungen). Danach WP2: **B1-U10 Geld & Entscheidungen** (Konjunktiv II der Vergangenheit), **B1-U11 Wissenschaft & Technik** (Konjunktiv I rezeptiv, Genitivpräpositionen, Zustandspassiv), **B1-U12 Diskussion** (Integration, keine neue Grammatik), **B1-R3**, **B1 Exit**. **Vor dem Abschluss von M7 ist CP-001 (Mediation) zu entscheiden.** Danach M8 (Audit A1-B1), M10 (C1), M11 (C2)
Last completed:     M7 WP1 (Teil 2) — B1-U08 Zusammenleben (2026-09-13, V-033)
