...
Next task:          A2-U07 ✅ · A2-U08 ✅ written (checks pass). NEXT: write GERMAN_LEARNING_PLAN/A2/A2-U09_Feste_und_Plaene/ (00_Overview + L1–L4; light unit) — plan in §6 WP3, then U10, A2-R3, A2 Exit, then validate WP3 (V-011)
